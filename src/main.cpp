...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in AvonCoin
    bool fStrictPayToScriptHash = true; // Always active in AvonCoin
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "September 9, 2016, Arjun Mishra builds avoncoin.";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("29271a33dccba47364efc967e1d5e0b27b35e81524700004d5527fd622678cdc"));
